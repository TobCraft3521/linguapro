...
const navigation = [
  { name: "Product", href: "#", onClick: scrollInfoIntoView },
  { name: "Features", href: "#", onClick: scrollInfoIntoView },
  { name: "Why choose us", href: "#", onClick: scrollInfoIntoView },
  { name: "Company", href: "#", onClick: scrollInfoIntoView },
]
...
export default function Hero() {
  ...
  const setupTypewriter = (typewriter: TypewriterClass) => {
    typewriter
      .typeString("<span class='text-sky-400'>French</span>")
      .pauseFor(1000)
      .deleteAll()
      .pauseFor(1000)
      .typeString("<span class='text-red-400'>Spanish</span>")
      .pauseFor(1000)
      .deleteAll()
      .pauseFor(1000)
      .typeString("<span class='text-green-500'>Italian</span>")
      .pauseFor(1000)
      .deleteAll()
      .pauseFor(1000)
      .typeString("<span class='text-yellow-400'>German</span>")
      .pauseFor(1000)
      .start()
  }
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden items-center gap-8 lg:flex lg:flex-1 lg:justify-end">
            <Link
              href="#"
              className="space-x-2 text-sm font-semibold leading-6 text-gray-900 dark:text-white"
            >
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl">
              ...
              that’s beyond fluency.
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-slate-200">
              Expand your horizons, discover new languages and cultures
              completely for free by signing up for LinguaPro today.
            </p>

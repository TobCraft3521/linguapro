...
const Pricing = () => {
  ...
  return (
    <div className="bg-white px-8 py-64 text-gray-900 dark:bg-black dark:text-white ">
      <h2 className="mb-12 text-center text-4xl font-extrabold">
        Pricing Plans
      </h2>
      <div className="flex flex-col items-center justify-center gap-8 md:flex-row">
        {/* Free Card */}
        <div className="min-h-[400px] w-full rounded-2xl border border-gray-300 p-6 shadow-md dark:border-gray-800 dark:bg-gray-800 md:w-1/5">
        ...
        {/* Paid Tier Card */}
        <div className="relative z-20 min-h-[400px] w-full rounded-2xl border border-indigo-600 p-6 shadow-md dark:bg-gray-800 md:w-1/5">
          <div className="absolute top-0 hidden h-32 w-full rounded-full bg-purple-900 blur-[120px] dark:block" />

          <h3 className="text mb-4 inline-block rounded-full border border-gray-500 px-4 py-1 font-semibold">
            Ultimate
          </h3>
          <p className="mb-6 ml-1 text-2xl font-bold">$ 12.99/month</p>
